  ...
  class ExportDatabaseTask extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... params) {
      ...
      String[] exportDbFiles = {
          Environment.getDataDirectory() + "/data/com.feldschmid.subdroid/databases/"
              + RepositoryDbAdapter.DATABASE_NAME,
          Environment.getDataDirectory() + "/data/com.feldschmid.subdroid/databases/" + RevisionDbAdapter.DATABASE_NAME,
          Environment.getDataDirectory() + "/data/com.feldschmid.subdroid/databases/" + ChangeDbAdapter.DATABASE_NAME };
    ...
    protected String doInBackground(final Void... args) {
      ...
      try {
        for (String importFile : importFiles) {
          ...
          File dbFile = new File(Environment.getDataDirectory() + "/data/com.feldschmid.subdroid/databases/"
