...
public class Subdroid extends ListActivity {
    ...
    private void startCheckUpdateService() {
    	if(PAID_VERSION) {
    		...
    		Toast.makeText(this, "UpdateService currently only available in donate version", Toast.LENGTH_SHORT).show();
    	}
    }
    ...
    private void fillData() {
        ...
        RepositoryDataAdapter repos =
        	    new RepositoryDataAdapter(this, R.layout.repository_row, repoCursor, from, to);
