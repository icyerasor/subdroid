...
package com.feldschmid.subdroid_donate.db;
...
public class RepositoryDbAdapter {
	...
	public Cursor fetchAllRepositories() {
		...
		Cursor mCursor = mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID,
				KEY_NAME, KEY_BASEURL, KEY_PATH, KEY_USER, KEY_PASS, KEY_LIMIT,
				KEY_INTERVAL, KEY_NOTIFICATION, KEY_REVNUMBER, KEY_LASTUSER,
				KEY_CHANGEDATE, KEY_NEWREVISIONS }, null, null, null, null,
				null);
	...
	public Cursor fetchRepository(long rowId) throws SQLException {
		...
		Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] {
				KEY_ROWID, KEY_NAME, KEY_BASEURL, KEY_PATH, KEY_USER, KEY_PASS,
				KEY_LIMIT, KEY_INTERVAL, KEY_NOTIFICATION, KEY_REVNUMBER,
				KEY_LASTUSER, KEY_CHANGEDATE, KEY_NEWREVISIONS, KEY_IGNORE_SSL,
    ...
    public void checkMDbAndReopen() {
      if(mDb == null || !mDb.isOpen()) {
        mDb = mDbHelper.getWritableDatabase();
        Log.e("RepositoryDbAdapter", "Had to reopen Db!");
      }
    }
}
